...
parser.add_argument('--save_dir', dest="save_dir", action="store", help ='Provide directory where checkpoint to be saved',default="checkpoint.pth")
parser.add_argument('--arch', dest='arch', default='vgg16',help = 'Provide the architecture name', choices=['vgg16', 'densenet121'])
parser.add_argument('--learning_rate', dest='learning_rate',help = 'Provide learning rate', default='0.001',type=float)
parser.add_argument('--hidden_units', dest='hidden_units',help = 'Hidden Units', default='512')
parser.add_argument('--epochs', dest='epochs', help = 'Number of epochs',default='1',type=int)
parser.add_argument('--gpu', action='store',help = 'GPU', default='gpu')
